export const m = {
  ...
  Question_Type: '问题类型',
  Choice_Question: '选择题',
  Single_Choice_Question: '单项选择题',
  Indefinite_Multiple_Choice_Question: '不定项选择题',
  Judge_Question: '判断题',
  Blank_Question: '填空题',
  Answer_Question: '简答题',
  Delete_Question_Tips: '你确定要删除该问题吗？',
  ...
  False: '错误',
  Delete_All: '全部删除',
  Delete_Choice_Tips: '你确定要删除所有选项吗？删除之后所有选项的内容将会消失！',
  Public_Question: '公开问题',
  Private_Question: '隐藏问题',
  Exam_Question: '考试问题',
