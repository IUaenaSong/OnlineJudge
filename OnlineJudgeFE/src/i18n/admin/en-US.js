export const m = {
  ...
  Contest_Exam_Problem: 'Contest/Exam Problem',
  ...
  Remove_Exam_Problem_Tips: 'Are you sure you want to remove the problem from the exam?',
  ...
  Enter_The_Problem_Display_ID_in_the_Exam: 'Enter The Problem Display ID in the Exam',
  ...
  Exam_Display_Title: 'Exam Display Title',
  Exam_Display_ID: 'Exam Display ID',
