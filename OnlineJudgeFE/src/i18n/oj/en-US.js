export const m = {
  ...
  Answer_Share: 'Answer Share',
  Add_Choice: 'Add Choice',
  Right_Answer: 'Right Answer',
  True: 'True',
  False: 'False',
  Delete_All: 'Delete All',
  Delete_Choice_Tips: 'Are you sure you want to delete all the choices? After deleting, the content of all the choices will disappear!',
