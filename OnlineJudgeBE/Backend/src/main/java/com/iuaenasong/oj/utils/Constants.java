...
public class Constants {
    ...
    public enum Account {
        ...
        CODE_CHANGE_MOBILE_FAIL("change-mobile-fail:"),
        CODE_CHANGE_MOBILE_LOCK("change-mobile-lock:"),
    ...
    public enum Mobile {
        ...
        MOBILE_KEY_PREFIX("mobile-user:"),
        CHANGE_MOBILE_LOCK("change-mobile-lock:");
