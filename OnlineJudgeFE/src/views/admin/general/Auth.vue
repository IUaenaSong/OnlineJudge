...
export default {
  ...
  methods: {
    ...
    deleteAuth(authId) {
      this.$confirm(this.$i18n.t('m.Delete_Auth_Tips'), this.$i18n.t('m.Warning'), {
    ...
    getRoleAuthList(page) {
      ...
      api.admin_getRoleAuthList(page, this.roleAuthPageSize, this.roleAuthKeyword, this.roleId).then(
        (res) => {
    ...
    submitRoleAuth(data = undefined) {
      ...
      let requestData;
      requestData = data;
      api.admin_createRoleAuth(requestData)
        .then((res) => {
