  ...
  <el-row>
    <el-col :span="24" style="margin-top: 10px; margin-bottom: 10px">
      <el-card class="card-top">
        ...
        <el-row :gutter="10">
          <el-col :xs="24" :md="12" style="margin-top: 5px; margin-bottom: 5px">
            <el-card>
              <div slot="header">
          ...
          <el-col :xs="24" :md="12" style="margin-top: 5px; margin-bottom: 5px">
            <el-card class="card-top">
              ...
              >
                <el-form-item
                  :label="
                    $t('m.Number_of_Groups_that_users_can_create_per_day')
                  "
                  label-width="320px"
                >
                  <el-input-number
                ...
                <el-form-item
                  :label="
                    $t(
                      'm.Total_number_of_groups_that_ordinary_users_can_create'
                    )
                  "
                  label-width="320px"
                >
