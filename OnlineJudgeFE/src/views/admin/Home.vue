    ...
    <div v-if="!mobileNar">
      ...
      <div id="header">
        <el-row>
          ...
          <el-col :span="4" v-show="isAuthenticated" style="margin: 0">
            <i
    ...
    <div v-else>
      ...
      <mu-drawer :open.sync="opendrawer" :docked="false" :right="false">
        <mu-list toggle-nested>
          ...
          >
            <mu-list-item-action>
              <mu-icon value=":fa fa-dashboard" size="24"></mu-icon>
            </mu-list-item-action>
          ...
          >
            ...
            <mu-list-item
              ...
              active-class="mobile-menu-active"
            >
              <mu-list-item-title>{{ $t("m.Auth_Admin") }}</mu-list-item-title>
            </mu-list-item>
            <mu-list-item
              button
              :ripple="false"
          ...
          >
            <mu-list-item-action>
              <mu-icon value=":fa fa-list" size="24"></mu-icon>
            </mu-list-item-action>
          ...
          >
            <mu-list-item-action>
              <mu-icon value=":fa fa-trophy" size="24"></mu-icon>
            </mu-list-item-action>
    ...
    handleCommand(command) {
      if (command === "logout") {
        api.admin_logout().then((res) => {
          ...
          this.$msg.success(this.$i18n.t("m.Log_Out_Successfully"));
