        ...
        switch (to.meta.access) {
          case 'discussion':
            if (!webConfig.openPublicDiscussion) {
              ...
              Vue.prototype.$msg.error('No Access: There is no open discussion area on the website!')
            }
            break
          case 'groupDiscussion':
            if (!webConfig.openGroupDiscussion) {
              ...
              Vue.prototype.$msg.error('No Access: There is no open group discussion area on the website!')
            }
            break
          case 'contestComment':
            if (!webConfig.openContestComment) {
              ...
              Vue.prototype.$msg.error('No Access: There is no open contest comment area on the website!')
            }
            break
          case 'judge':
            if (!webConfig.openPublicJudge) {
              next({
                path: '/home'
              })
              Vue.prototype.$msg.error('No Access: There is no open public judge area on the website!')
            }
            break
          case 'groupJudge':
            if (!webConfig.openGroupJudge) {
              next({
                path: '/home'
              })
              Vue.prototype.$msg.error('No Access: There is no open group judge area on the website!')
            }
            break
          case 'contestJudge':
            if (!webConfig.openContestJudge) {
              next({
                path: '/home'
              })
              Vue.prototype.$msg.error('No Access: There is no open contest judge area on the website!')
            }
            break
        }
      }
