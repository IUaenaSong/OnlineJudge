...
public class ConfigUtils {
    ...
    public String buildYamlStr(ConfigVo configVo) {
        return "oj:\n" +
                ...
                "  mobile:\n" +
                "    domain: " + configVo.getMobileDomain() + "\n" +
                "    regionId: " + configVo.getMobileRegionId() + "\n" +
                "    accessKeyId: " + configVo.getMobileAccessKeyId() + "\n" +
                "    secret: " + configVo.getMobileSecret() + "\n" +
                "    signName: " + configVo.getMobileSignName() + "\n" +
                "    templateCode: " + configVo.getMobileTemplateCode() + "\n" +
                "  redis:\n" +
